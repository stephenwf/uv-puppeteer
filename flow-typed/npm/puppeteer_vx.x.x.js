...
export type PageEvents = console |
  dialog |
  error |
  frameattached |
  framedetached |
...
export interface FrameBase {
  ...
  waitForFunction(fn: string | Function, options?: PageFnOptions, ...args: any[]): Promise<void>,
  waitForSelector(
    selector: string,
    options?: {
      visible?: boolean,
...
export type Page = {
  ...
  on<K>(
    eventName: K,
    handler: (e: "NO PRINT IMPLEMENTED: IndexedAccessType", ...args: any[]) => void): Page,
...
export type Browser = {
  ...
  on<K>(
    eventName: K,
    handler: (e: "NO PRINT IMPLEMENTED: IndexedAccessType", ...args: any[]) => void): Browser,
